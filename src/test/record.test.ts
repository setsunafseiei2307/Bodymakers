...
describe('record summary', () => {
  ...
  it('counts only records in the current week without changing saved data', () => {
    ...
    data.dailyLogs = [
      { date: '2026-09-01', savedAt: '', weightKg: 70, meals: [{ foodId: '01001', grams: 100 }], exercises: [], muscles: [], doneExercises: ['bench-press'], manualIntake: { kcal: null, protein: null }, steps: null, sleepHours: 7, nutritionComplete: false },
      { date: '2026-08-28', savedAt: '', weightKg: 71, meals: [], exercises: [], muscles: [], doneExercises: [], manualIntake: { kcal: null, protein: null }, steps: null, sleepHours: null, nutritionComplete: false },
    ];
